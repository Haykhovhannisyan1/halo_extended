...
>(
    ...
    // // ZKFFT
    // let n = params.n;
    // let unusable_rows_start = params.n - (vk.cs.blinding_factors() as u64 + 1);
    // let mut b = vec![];
    // // let start_time = Instant::now();
    // for i in 0..unusable_rows_start {
    //     b.push(vk.domain.get_omega_powers_i(i as u64));
    // }
    // let tmp = vec![C::Scalar::ZERO; n as usize];
    // for _ in unusable_rows_start..n {
    //     b.push(tmp.clone());
    // }
    // // let end_time = Instant::now();
    // // let elapsed_time = end_time.duration_since(start_time);
    // // println!("b time veirifer: {:?}ms", elapsed_time.as_millis());

    // let final_commit = transcript.read_point()?;

    // optimized_wip::verify(
    //     transcript,
    //     params.g.clone(),
    //     params.gen_g.clone(),
    //     params.w.clone(),
